import {FileType, ParsedRequest, Theme} from '../api/_lib/types';
...
const imageLightOptions: DropdownOption[] = [
    {text: 'Antonio Leutsch Solid', value: 'https://antonio-leutsch.com/antonioleutsch-logo-fill-black.svg'},
    {text: 'Antonio Leutsch Outline', value: 'https://antonio-leutsch.com/antonioleutsch-logo-outline-black.svg'},
];

const imageDarkOptions: DropdownOption[] = [
    {text: 'Antonio Leutsch Solid', value: 'https://antonio-leutsch.com/antonioleutsch-logo-fill-white.svg'},
    {text: 'Antonio Leutsch Outline', value: 'https://antonio-leutsch.com/antonioleutsch-logo-outline-white.svg'},
];
